<template>
    <div :class="classes" @click="clickHandler">
        ...
        <!-- 슬롯: 썸네일 -->
        <slot name="thumbnail" :default-class="thumbnailClasses" :image-class="'vs-symbol-thumbnail-image'" />

        <!-- 슬롯: 스트로크 -->
        <slot name="stroke" :default-class="'vs-symbol-stroke'" />
    </div>
</template>
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const iconClasses = computed(() => {
            const defaultClass = "vs-symbol-icon";
        ...
        const thumbnailClasses = computed(() => {
            const defaultClass = "vs-symbol-thumbnail";
