<template>
    <div :class="classes">
        <input
            ...
            :checked="isChecked"
        />
        <slot name="label" :default-class="'vs-checkbox-label'">
            <label v-if="useLabel" class="vs-checkbox-label" :for="id">
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        const classes = computed(() => {
            const defaultClass = "vs-checkbox";
            ...
            return [defaultClass, sizeClass, alignClass, readonlyClass, disabledClass];
        });
